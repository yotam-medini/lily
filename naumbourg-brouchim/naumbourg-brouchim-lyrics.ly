...
sLyricsText = \lyricmode {
  ...
  mo __ chos rov rob vo os  y zv ho -- el  lo -- hem  oul  -- chol  a -- das 
  lo -- hem oul -- chol a -- das  jis -- ro -- el   se -- mo -- chos rav ron 
    vo  -- oz  je -- 
...
aLyricsText = \lyricmode {
  ...
  be --  chou -- po -- som 
  be --  chou -- po -- som 
  yee -- rav kol  gi -- loh  se --

  mo -- chos  rav  ron  lo -- hem  oul  -- chol  a -- das 
  lo -- hem oul -- chol a -- das  jis -- ro -- el 
    s -- mo -- chos  rav
  ron    lo -- hem  oul -- chol  a -- das  lo -- hem 
    oul -- chol  a -- das  jis -- ro -- el
}

aHLyricsText = \lyricmode {
  % ORPG-1
...
tLyricsText = \lyricmode {
  ...
  yee -- rav kol  be --  
  chou  -- po -- som  be -- 
  chou  -- po -- som  jee -- rav  kol  gi -- loh 
...
tLyricsText = \lyricmode {
  ...
  se -- mo -- chos rav ron vo -- os  ye -- zav  ho -- el 
    lo -- hem  oul  -- chol  a -- das  lo --
  hem  oul -- chol  a -- das  jis -- ro -- el  se -- mo  -- chos 
      rav ron vo -- os  ye -- zav ho --
  el  lo -- hem  oul -- chol  a -- das  lo -- hem 
    oul -- chol  a -- das  jis -- ro -- el
}
...
bLyricsText = \lyricmode {
  ...
  hem oul -- chol a -- das  jis -- ro -- el  se -- mo -- chos  rov
  ron  lo -- hem  oul -- chol  a -- das  lo -- hem 
    oul -- chol  a -- das  jis -- ro -- el
}
