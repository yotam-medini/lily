...
\break
  ...
  \time 5/4 a4 fs,16[( fs b a] cs8) e fs4.( e8) |
  \break % bar 13
  \time 7/4 e4 r4 f2 r4 r4 cs4 |
  b4. b8 cs4 b8 cs8 b8.[( as16]) gs4 cs8 cs |
\break
  % page 24, bar 15
  b4. b8 cs4 b8 c b8.[( as16]) gs8 r8 cs4 |
...
basMusic = \relative c {
  ...
  % page 25, bar 19
  r4 r4 e4 |
  e4. e8 fs4 fs8 fs8    e4 e8 r8 gs8 fs8 |
  e4. e8 fs4 gs8 fs8
  % break bar ..21
    e4~ e8 r8 a!4 |
